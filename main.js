function Encrypt(e, t, n, a, Key, random_number) {
    var o = [];
    ...
    var r = RSAEncrypt(o, i, random_number);
    return r
}
function PackageSAData(e, t) {
    ...
    for (n[a++] = 2 * i,
    o = 0; i > o; o++) {
        n[a++] = 255 & t.charCodeAt(o),
        n[a++] = (65280 & t.charCodeAt(o)) >> 8
    }
    var r = e.length;
    for (n[a++] = r,
    o = 0; r > o; o++) {
        n[a++] = 127 & e.charCodeAt(o)
    }
    return n
}
...
function PackageLoginIntData(e) {
    ...
    for (t = 0; t < e.length; t++) {
        n[a++] = 255 & e.charCodeAt(t),
        n[a++] = (65280 & e.charCodeAt(t)) >> 8
    }
    return n
}
...
function encryption_handler(password, encryption_key, random_number) { // encryption_key and random_number can be obtained from the signup html
    return Encrypt("", "", "newpwd", password, encryption_key, random_number)
} 

module.exports = { encryption_handler }
